    ...
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-theme-bg relative">
      ...
      <div className="hidden md:flex flex-1 flex-col justify-between p-12 bg-theme-surface border-r border-theme-border relative overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-md">
          <h2 className="text-display-lg text-theme-text-primary mb-6">Welcome back to your workspace.</h2>
          <p className="text-subtitle text-theme-text-secondary mb-12">
            Log in to manage your connected Instagram accounts, track active automations, and view your DM analytics.
          </p>

          {/* Mini Live Preview */}
          <div className="w-full border border-theme-border rounded-2xl bg-theme-bg p-4 shadow-surface">
            <div className="flex gap-3 ml-8">
              ...
              <div className="bg-theme-surface border border-theme-border rounded-2xl rounded-tl-sm px-4 py-2">
                <p className="text-sm text-theme-text-primary">Sent 124 DMs today! 🚀</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-end md:justify-center p-4 md:p-12 relative z-10 min-h-screen md:min-h-0">
        ...
        <div className="w-full max-w-md mx-auto bg-theme-surface md:bg-transparent rounded-t-[32px] md:rounded-none p-8 md:p-0 pt-6 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] md:shadow-none relative">
          ...
          <div className="mb-8 md:text-left text-center">
            <h1 className="text-title text-theme-text-primary mb-2">Sign in to your account</h1>
            <p className="text-sm text-theme-text-secondary font-medium">
              Don't have an account? <Link to="/register" className="text-theme-text-primary hover:underline">Sign up free</Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                 ...
                 <Link to="/forgot-password" className="text-label hover:text-theme-text-primary transition-colors">Forgot password?</Link>
              </div>
